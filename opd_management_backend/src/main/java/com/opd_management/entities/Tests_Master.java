...
public class Tests_Master {
	...
	public Tests_Master(int id, String test_name, String normal_range, String unit, Doctor doctorid) {
		super();
		this.id = id;
		this.test_name = test_name;
		this.normal_range = normal_range;
	...
	public String toString() {
		return "Tests_Master [id=" + id + ", test_name=" + test_name + ", normal_range=" + normal_range + ", unit="
